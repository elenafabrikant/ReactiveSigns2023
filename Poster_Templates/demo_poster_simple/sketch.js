...
function draw() {
  background(0, 0, 0, 50);
  fill(255);
  wordEffect("Confused", poster.screens[0].cntX, poster.screens[0].cntY);
  wordEffect("End focus", poster.screens[1].cntX, poster.screens[1].cntY);
...
function wordEffect(word, x, y) {
  push()
  translate(x, y);
  rotate(poster.posNormal.x * 8 * PI);
